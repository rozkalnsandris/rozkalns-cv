...
class RecruiterCopy417Tests(unittest.TestCase):
    ...
    def test_recruiter_copy_regressions(self) -> None:
        ...
        self.assertEqual(en["e1_dates"], "Jan 2024 – Dec 2026 (planned)")
        self.assertEqual(en["e2_dates"], "Jul 2023 – Dec 2023")
        self.assertIn("KBS", en["e2_org"])
        ...
        self.assertEqual(de["e1_dates"], "Jan. 2024 – Dez. 2026 (geplant)")
        self.assertEqual(de["e2_dates"], "Juli 2023 – Dez. 2023")
        self.assertEqual(de["e3_dates"], "Mai 2020 – Juni 2023")
        self.assertNotIn("Vorher-/Nachher-Evidenz", de["p3_ops"])
        self.assertNotIn("Praxiserfahrung", de["skills_working"])

        self.assertEqual(lv["e1_dates"], "2024. g. janvāris – plānots līdz 2026. g. decembrim")
        self.assertEqual(lv["e2_dates"], "2023. g. jūlijs – 2023. g. decembris")
    ...
    def test_learning_skills_remain_learning_only(self) -> None:
        for messages in self.messages.values():
            ...
            self.assertIn("SQL", learning)
            self.assertNotIn("Terraform", learning)
            self.assertNotIn("AWS Cloud", learning)
