...
class DeployContractTests(unittest.TestCase):
    ...
    def test_helper_never_restarts_shared_tunnel(self) -> None:
        ...
        self.assertIn("docker compose up -d --build --no-deps cv cvbot", text)
    ...
    def test_validation_uses_host_only_env_placeholders(self) -> None:
        ...
        self.assertIn('create_placeholder "$ROOT/bot/.env"', text)
        self.assertIn('create_placeholder \
        "$ROOT/cloudflared.env"', text)
