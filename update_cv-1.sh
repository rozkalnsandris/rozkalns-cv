...
echo "📄 bot/requirements.txt (paliek nemainīgs, bet pārliecinos)"
cat > bot/requirements.txt << 'REQ'
Flask==3.0.3
requests==2.32.3
gunicorn==23.0.0
REQ

echo "📄 bot/.env.example (paliek nemainīgs)"
cat > bot/.env.example << 'ENV'
...
echo "✅ Visi faili izveidoti! Tagad izpildi:"
echo "  chmod +x stats.sh"
echo "  docker compose down && docker compose up -d --build"
echo "  ~/docker/cv/stats.sh      # lai uzreiz atjaunotu statistiku"
EOF