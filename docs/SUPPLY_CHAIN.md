...
4. Regenerate `bot/requirements.lock` with Python 3.12 and
   `pip-tools==7.5.1` using `--generate-hashes --resolver=backtracking
   --strip-extras`.
...
Never edit individual hashes or transitive versions by hand.
